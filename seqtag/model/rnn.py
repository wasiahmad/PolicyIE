...
PRETRAINED_VOCAB_FILES_MAP = {
    "vocab_file": {
        "rnn": "https://s3.amazonaws.com/models.huggingface.co/bert/bert-base-uncased-vocab.txt",
    }
}
...
PRETRAINED_INIT_CONFIGURATION = {
    "rnn": {"do_lower_case": True},
}


class RNNTokenizer(BertTokenizer):
    r"""
...
class JointRNN(nn.Module):
    ...
    def forward(self, input_ids, attention_mask, intent_label_ids, slot_labels_ids):
        ...
        sequence_output = self.model(embeddings)[0]
